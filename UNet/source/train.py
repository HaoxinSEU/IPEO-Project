...
#dir_mask = Path('./data/train/target')
...
def train_model(
    ...
    data_dir = "/kaggle/input/deoldify/Forest_Deoldify_part"
    ...
    for epoch in range(1, epochs + 1):
            ...
            for batch in dataloaders_dict['train']:
                ...
                if division_step > 0:
                    if global_step % division_step == 0:
                        ...
                        val_score = evaluate(model, dataloaders_dict['val'], device, amp)
        ...
        if save_checkpoint:
            ...
            torch.save(state_dict, str('checkpoint_epoch{}.pth'.format(epoch)))
